...
class mytest(unittest.TestCase):
  ...
  def test_shout(self):
	...
	self.assertNotEqual("DO NOT YELL", lab3_drm.shout("do not yell"))
	self.assertNotEqual("7", lab3_drm.shout(7))
  ...
  def test_reverse(self):
	...
	self.assertNotEqual("987", lab3_drm.reverse(789))
  ...
  def test_reversewords(self):
	...
	self.assertNotEqual("87 98", lab3_drm.reversewords(9887))
  ...
  def test_reversewordletters(self):
	...
	self.assertNotEqual("89 78", lab3_drm.reversewordletters(9887))

  def test_piglatin(self):
	self.assertEqual("esethay etzelspray areay akingmay emay irstythay", lab3_drm.piglatin("these pretzels are making me thirsty"))
